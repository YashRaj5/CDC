...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F01-Retail_DLT_CDC_SQL&cid=7025545470751501&uid=8403325238548640">
...
-- MAGIC
-- MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/68d3fc49-c1af-4e94-b51b-bb29be094268">Delta Live Table Pipeline for CDC</a>.
...
-- DBTITLE 1,Inputing data from cdc
-- MAGIC %python
...
-- DBTITLE 1,Let's ingest our incoming data
CREATE STREAMING LIVE TABLE customers_cdc 
COMMENT "New customer data incrementally ingested from cloud object storage landing zone"
AS SELECT * FROM cloud_files("/tmp/cdc_raw/customers", "json", map("cloudFiles.inferColumnTypes", "true"));
...
-- DBTITLE 1,Silver Layer - Cleansed Table
